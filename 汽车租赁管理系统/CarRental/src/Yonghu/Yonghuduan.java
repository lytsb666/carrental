...
//
	...
	public void connDB() { // 连接数据库
		...
		try {//创建连接
			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/car_rental?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&allowPublicKeyRetrieval=true&useSSL=false", "root", "147330");
